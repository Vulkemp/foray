...
namespace hsk {
    void FlipImageStage::Init(const VkContext* context, ManagedImage* sourceImage)
    {
        mContext     = context;
    ...
    void FlipImageStage::PrepareAttachments()
    {
        ...
        mFlipImages.push_back(std::make_unique<ManagedImage>());
    ...
    void FlipImageStage::RecordFrame(FrameRenderInfo& renderInfo)
    {
    ...
    void FlipImageStage::OnResized(const VkExtent2D& extent, ManagedImage* newSourceImage)
    {
