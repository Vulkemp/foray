...
namespace hsk {
    ...
    void Tlas::Create()
    {
        ...
        for (const auto& blasInstancePair : mBlasInstances){
        ...
        mInstanceBuffer.Create(mContext,
                               ...
                               sizeof(VkAccelerationStructureInstanceKHR) * instanceBufferData.size(), VMA_MEMORY_USAGE_AUTO_PREFER_DEVICE, VMA_ALLOCATION_CREATE_HOST_ACCESS_SEQUENTIAL_WRITE_BIT);
        ...
        geometry.geometry.instances = VkAccelerationStructureGeometryInstancesDataKHR{
            ...
            .data            = mInstanceBuffer.GetDeviceAddress(),
        };
