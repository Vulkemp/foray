...
namespace hsk {
    ...
    class DualBuffer : public NoMoveDefaults
    {
      public:
        ...
        void Create(const VkContext* context, const ManagedBuffer::ManagedBufferCreateInfo& devicebufferCreateInfo, uint32_t stageBufferCount = INFLIGHT_FRAME_COUNT);
        ...
        HSK_PROPERTY_ALLGET(DeviceBuffer)
      ...
      protected:
        ...
        std::vector<std::unique_ptr<ManagedBuffer>> mStagingBuffers;
