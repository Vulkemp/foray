...
namespace hsk {
    void ManagedUboBase::Create(const VkContext* context, VkDeviceSize size, uint32_t stageBufferCount)
    {
        Destroy();
        ManagedBuffer::ManagedBufferCreateInfo ci(VkBufferUsageFlagBits::VK_BUFFER_USAGE_UNIFORM_BUFFER_BIT | VkBufferUsageFlagBits::VK_BUFFER_USAGE_TRANSFER_DST_BIT, size,
