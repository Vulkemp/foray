...
namespace hsk {
    ...
    class ShaderBindingTableBase
    {
      ...
      public:
        ...
        virtual void Build(const VkContext* context, const VkPhysicalDeviceRayTracingPipelinePropertiesKHR& pipelineProperties, const std::vector<const uint8_t*>& handles);
