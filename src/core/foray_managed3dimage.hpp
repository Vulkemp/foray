...
namespace foray::core {
    ...
    class Managed3dImage : public VulkanResource<VkObjectType::VK_OBJECT_TYPE_IMAGE>
    {
      public:
        inline Managed3dImage() : VulkanResource("Unnamed Image") {}
        inline ~Managed3dImage() override { Destroy(); }
        ...
        struct CreateInfo
        {
            ...
            /// @param extent 3D Size
            /// @param name Debug object name
            CreateInfo(VkImageUsageFlags usage, VkFormat format, const VkExtent3D& extent, std::string_view name = "Unnamed Image");
        };
        ...
        /// @param context Requires Allocator, DispatchTable, Device
        virtual void Create(Context* context, VkImageUsageFlags usage, VkFormat format, const VkExtent3D& extent, std::string_view name = "Unnamed Image");
        ...
        virtual void TransitionLayout(Managed3dImage::QuickTransition& quickTransition, VkCommandBuffer commandBuffer = VK_NULL_HANDLE);
        ...
        bool Exists() const override { return mAllocation; }
