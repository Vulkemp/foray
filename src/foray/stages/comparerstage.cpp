#include "comparerstage.hpp"
#include "../osi/inputdevice.hpp"
#include "../osi/osi_event.hpp"
#include "../osi/osmanager.hpp"

const uint32_t SHADER_F[] =
#include "comparerstage.f.comp.spv.h"
    ;
const uint32_t SHADER_I[] =
#include "comparerstage.i.comp.spv.h"
    ;
const uint32_t SHADER_U[] =
#include "comparerstage.u.comp.spv.h"
    ;
