...
namespace foray::osi {
    ...
    int16_t InputDevice::AxisJoystick::State() const
    {
        return SDL_JoystickGetAxis(Joystick, mId);
    }
    bool InputDevice::ButtonJoystick::State() const
    {
        return SDL_JoystickGetButton(Joystick, mId) > 0;
    }
